...
export async function revisarConteudo({ fm, body, research = "", categoria = "", fetchLLM }) {
  ...
  const usuario = [
    ...
    "   IMPORTANTE: precos, notas em estrelas, numero de avaliacoes e o criterio \"citado em N reviews\" vem do catalogo de produtos e da pesquisa de consenso, NAO da lista de fontes acima. Nao marque esses numeros como sem suporte — avalie apenas datas, fatos e afirmacoes do texto corrido.",
